...
import 'package:bidbuyweb/presentation/Desktop/login2.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class LoginHomeView extends StatelessWidget {
  const LoginHomeView({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              LoginCenteredWidgets(),
              SizedBox(
                height: 30,
              ),
              LoginSecondLastContainer(),
              SizedBox(
                height: 30,
              ),
              LoginFooterWidget(),
...
class LoginSecondLastContainer extends StatelessWidget {
  const LoginSecondLastContainer({super.key});
...
class LoginLastline extends StatelessWidget {
  const LoginLastline({super.key});
